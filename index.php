...
<html lang="en">
  <head>
    ...
    <title>Platform Pasar Virtual untuk UMKM </title>
      ...
      <section class="store-landing">
        <div class="container">
          <div class="row align-items-center justify-content-between">
            <div class="col-md-5">
              <img src="assets/images/icon1.png" class="w-100" alt="" />
            </div>
            <div class="col-md-6">
              <h1 style="font-weight: bold; margin-bottom: 15px;">Pajakku</h1>
              <p class="store-subtitle-landing" style="line-height: 28px; color: rgb(146, 146, 146); text-align: justify;">
              Pajakku muncul sebagai Platform Pasar Virtual yang bertujuan untuk memberikan dukungan kepada 
              UMKM lokal dalam hal mobilitas mereka. Dengan memberikan layanan virtual, Pajakku memudahkan UMKM 
              lokal untuk mengembangkan bisnis mereka secara online dan meningkatkan aksesibilitas produk mereka 
              kepada konsumen yang lebih luas.
              </p>
  ...
  <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>
                ...
                <div class="card-body">
                  <div class="row justify-content-center align-content-center">
                    ...
                    <div class="col-md-8">
                      ...
                      >
                        <div class="title-text"><B>Fast Delivery</B></div>
                        <div class="subtitle-text"> 
                        Pajakku menyediakan layanan pengiriman cepat agar dapat memastikan produk UMKM lokal tiba tepat waktu ke tangan konsumen
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row justify-content-center align-content-center">
                    ...
                    <div class="col-md-8">
                      <div
                        class="adventege-description text-center text-lg-left"
                      >
                        <div class="title-text"><B>More Efficient</B></div>
                        <div class="subtitle-text">
                        Solusi yang lebih efisien untuk UMKM lokal dalam mengelola proses bisnis, mengoptimalkan produktivitas, dan meningkatkan kinerja secara keseluruhan.
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row justify-content-center align-content-center">
                    ...
                    <div class="col-md-8">
                      <div
                        class="adventege-description text-center text-lg-left"
                      >
                        <div class="title-text"><B>Environment Friendly</B></div>
                        <div class="subtitle-text">
                        Layanan yang ramah lingkungan untuk UMKM lokal, menjaga kualitas produk sambil mengurangi dampak negatif terhadap lingkungan sekitar.
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-12" data-aos="fade-up">
              <h5 style="font-weight: 600; margin-bottom: 15px;">Produk terbaru</h5>
            </div>
          </div>
          <div class="row">
            <?php 
    ...
    <style>
      ...
      /* Fade-in transition for the page content */
      .fade-in {
        opacity: 0;
