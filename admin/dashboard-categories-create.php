...
if (isset($_POST["tambahCategory"])) {
    // Debug untuk melihat apakah data dikirimkan
    echo '<pre>';
    print_r($_POST);  // Debug: untuk melihat data POST
    echo '</pre>';
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12 text-right">
                                        <button type="submit" name="tambahCategory" class="btn btn-success px-4">Save Now</button>
                                    </div>
                                </div>
                            </div>
                        </div>
